    ...
    if (Object.prototype.hasOwnProperty.call(AuditMessage, 'ActiveParticipant')) {
      AuditMessage.ActiveParticipant.forEach((ap) => {
        ...
        if (Object.prototype.hasOwnProperty.call(ap, 'MediaIdentifier') && ap.MediaIdentifier.length > 0) {
          for (let mediaIdentifierIndex = 0; mediaIdentifierIndex < ap.MediaIdentifier.length; mediaIdentifierIndex++) {
            const MediaIdentifier = ap.MediaIdentifier[mediaIdentifierIndex]

            if (Object.prototype.hasOwnProperty.call(MediaIdentifier, 'MediaType') && MediaIdentifier.MediaType.length > 0) {
              for (let mediaTypeIndex = 0; mediaTypeIndex < MediaIdentifier.MediaType.length; mediaTypeIndex++){
                const MediaType = MediaIdentifier.MediaType[mediaTypeIndex]
        ...
        if (ap.$.NetworkAccessPointTypeCode) {
