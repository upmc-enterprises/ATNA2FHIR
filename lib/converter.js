        ...
        if (poi.$.ParticipantObjectID) {
          ...
          if (
            ...
            entity.what.type = {
              coding: [
                {
                  code: participantObjectIdTypeCode.$['csd-code']
                }
              ],
              text: participantObjectIdTypeCode.$.originalText
            }

            if (participantObjectIdTypeCode.$.codeSystemName.toLowerCase() === 'dcm') {
              entity.what.type.coding[0].system = enums.CODING_SYSTEM_HL7_SECURITY_SOURCE_TYPE
            } else {
              entity.what.type.coding[0].system = participantObjectIdTypeCode.$.codeSystemName
            }
          }
        }
